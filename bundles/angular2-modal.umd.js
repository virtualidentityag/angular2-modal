    ...
    exports.Overlay = (function () {
        ...
        Overlay.prototype.createOverlay = function (renderer, vcRef, config, group) {
            ...
            if (vcRef) {
                ...
                var contentComponentFactory = this._componentFactoryResolver.resolveComponentFactory(exports.ModalOverlay);
                var modalContentInjector = _angular_core.ReflectiveInjector.resolveAndCreate([{ provide: DialogRef, useValue: dialog }], this._injector);
