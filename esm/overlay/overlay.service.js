...
import { Injectable, ApplicationRef, Injector, ComponentFactoryResolver, ReflectiveInjector } from '@angular/core';
...
var Overlay = (function () {
    function Overlay(_modalRenderer, _applicationRef, _injector, _componentFactoryResolver) {
    ...
    Overlay.prototype.createOverlay = function (renderer, vcRef, config, group) {
        ...
        if (vcRef) {
            ...
            var contentComponentFactory = this._componentFactoryResolver.resolveComponentFactory(ModalOverlay);
            var modalContentInjector = ReflectiveInjector.resolveAndCreate([{ provide: DialogRef, useValue: dialog }], this._injector);
